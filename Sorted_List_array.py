...
class Sorted_List:
    ...
    def index(self, key):
        ...
        if len(self._values) != 0:
            for value in self._values:
                if value == key:
                    i = int(self._values.index(value))
                else:
                    i = -1
        else:
            i = -1
    ...
    def __eq__(self, target):
        ...
        for i in range(len(self._values)):
            if i >= len(target._values) or self._values[i] != target._values[i]:
                ans = False
    ...
    def split(self):
        ...
        """
        # Your code here
        m = len(self._values) // 2
        
        
        target1 = self._values[:m]
        target2 = self._values[m:]
        self._values = []
    ...
    def split_alt(self):
        ...
        for i in range(len(self._values)):
            if i % 2 == 0:
                even.append(self._values[i])
            else:
                odd.append(self._values[i])
    
        target1 = Sorted_List()
        target2 = Sorted_List()
        target1._values = even
        target2._values = odd
        self._values = []
