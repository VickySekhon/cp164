...
class Priority_Queue:
    ...
    def remove(self):
        ...
        # the value of self._first 
        self._first = self._values.index(min(self._values))
        
        # simply returns the value of the most important index 
        value = self._values[self._first]
        
        # takes out the value from the items in the queue (take self._first out of the queue to reassign it)
        self._values.pop(self._first)
        
        # reassigning the value of self._first
        # if there's more than 0 items in the queue...
        if len(self._values) > 0:
            
            # the value of first becomes the index of the smallest value 
            self._first = self._values.index(min(self._values))
        
        # if there is 0 items in the queue the value of first is irrelevant and defaults to None
        else:
            self._first = None
