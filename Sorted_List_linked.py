...
class Sorted_List:
    ...
    def insert(self, value):
        ...
        if self._front is None:
            ...
            prev = None
            i = 0
            while i < self._count and curr._value <= value:
                prev = curr 
                curr = curr._next
                i += 1
            if prev is None:
    ...
    def count(self, key):
        ...
        _, countt, _ = self._linear_search(key)
        while countt is not None and countt._value == key:
            number += 1
            countt = countt._next
    ...
    def clean(self):
        ...
        while curr is not None:
            _, c, _ = self._linear_search(curr._value)
            if c != curr:
    ...
    def union(self, source1, source2):
        ...
        while source2_node is not None:
            value2 = source2_node._value
            _, current, _ = self._linear_search(value2) 
